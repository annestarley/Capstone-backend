...
const getScienceArticles = () => {
  return axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=science&pageSize=2&apiKey=a4d490bdd93d405d8bc422ace61c795f`)
    .then(res => {
...
const getSportsArticles = () => {
  return axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=sports&pageSize=2&apiKey=a4d490bdd93d405d8bc422ace61c795f`)
    .then(res => {
...
const getBusinessArticles = () => {
  return axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=business&pageSize=2&apiKey=a4d490bdd93d405d8bc422ace61c795f`)
    .then(res => {
...
const getHealthArticles = () => {
  return axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=entertainment&pageSize=2&apiKey=a4d490bdd93d405d8bc422ace61c795f`)
    .then(res => {
...
const getTechnologyArticles = () => {
  return axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=technology&pageSize=2&apiKey=a4d490bdd93d405d8bc422ace61c795f`)
    .then(res => {
